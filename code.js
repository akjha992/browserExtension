...
const addButtons = ()=>{
    ...
    if(!superSkipButton){
        const newButton = '<button style="height:50px;width:200px;text-align:center;position:relative;bottom:-400px;right:-20px;" id="superSkipButton" type="button">Fast Skip</button>'
